...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"scripts/runApi.js":[function(require,module,exports) {
"use strict";
...
function genYearSlider(data, sliderClass) {
  ...
  var yearSlider = groupInput.append("input").attr("class", sliderClass).attr("type", "range").attr("min", "0").attr("max", data.length - 1).attr("value", 0);
...
function scotterPlot(data) {
  ...
  (0, _dropDownMenu.genOptionsForDropdownMenu)(data, yMenuClass);
  ...
  var points = pointgroup.selectAll("circle").data(data[0].entries).enter().append("circle").attr("class", function (d) {
    ...
    tooltip.style("left", d3.event.pageX + "px").style("top", d3.event.pageY - 150 + "px").style("opacity", 1).style("display", "inline-block").html("<h3> " + d.naam + "</h3>" + "<span>Plaats :</span>   " + d.plaats + "<br>" + "<span>Concerncode :</span>   " + d.concerncode + "<br>" + "<h4> Soort zorg </h4>" + "<span class='legenda-one'>Gehandicaptenzorg :</span>   " + d.gehandicapten + "<br>" + "<span class='legenda-two'>Geestelijkegezondheidszorg :</span>   " + d.geestelijk + "<br>" + "<span class='legenda-three'>Thuiszorg :</span>   " + d.thuiszorg + "<br>" + "<h4> Cijfers uit   " + d.jaar + "</h4>" + "<span>Omzet :</span>   " + d.omzet + "<br>" + "<span>Winst :</span>   " + d.winst + "<br>" + "<span>Personeelskosten :</span>   " + d.personeelskosten + "<br>" + "<span>Omzet per FTE :</span>   " + d.omzet_fte + "<br>" + "<span>Winst percentage :</span>   " + d.perc_winst + "%<br>" + "<span>Loon percentage :</span>   " + d.perc_loon + "%<br>");
    points.style("opacity", .2);
    this.setAttribute("style", "opacity: 1; stroke-width: 3; stroke: black;");
  }).on("click", function (d) {
    d3.select('.saved-list').append('li').style("opacity", 1).style("display", "inline-block").attr("class", "data-list").html("<h3> " + d.naam + "</h3>" + "<span>Plaats :</span>   " + d.plaats + "<br>" + "<span>Concerncode :</span>   " + d.concerncode + "<br>" + "<h4> Soort zorg </h4>" + "<span class='legenda-one'>Gehandicaptenzorg :</span>   " + d.gehandicapten + "<br>" + "<span class='legenda-two'>Geestelijkegezondheidszorg :</span>   " + d.geestelijk + "<br>" + "<span class='legenda-three'>Thuiszorg :</span>   " + d.thuiszorg + "<br>" + "<h4> Cijfers uit   " + d.jaar + "</h4>" + "<span>Omzet :</span>   " + d.omzet + "<br>" + "<span>Winst :</span>   " + d.winst + "<br>" + "<span>Personeelskosten :</span>   " + d.personeelskosten + "<br>" + "<span>Omzet per FTE :</span>   " + d.omzet_fte + "<br>" + "<span>Winst percentage :</span>   " + d.perc_winst + "%<br>" + "<span>Loon percentage :</span>   " + d.perc_loon + "%<br>" + "<div class='remove-list'></div>");
...
function nestDataFunc(data) {
  var nestedData = d3.nest().key(function (d) {
    ...
    var test = {};
    var plaats;
    group.values.map(function (item) {// item.values.map(object => {
